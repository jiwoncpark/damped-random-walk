...
def plot_fig3_bottom(df, bandpass=None):
...
def plot_2d_hist(x_values, y_values, x_bins, y_bins, invert_y_axis, ticks_color, invert_color, log_color, x_label, y_label, color_label, cmap_name):
